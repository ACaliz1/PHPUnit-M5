...
public class FinalFunctionalOrderTest {
    public static void main(String[] args) {
        try {
            ...
            Order o = Order.getInsanceOrder("8391047281", "Carrer Del Frances", "David Espinosa",
             "Amazon", "749184924", "Operation", null, null, 
             "El paquete es paquetil");
            ...
            o.setFinishDate("2020-05-04 22:22:22");
            System.out.println("El estado de la orden es " + o.getStatus());
